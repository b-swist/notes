...
\begin{definition}
  \bi{Natężenie pola elektrostatycznego} to stosunek siły elektrostatycznej działającej na
...
\begin{definition}
  \bi{Pojemność elektryczna przewodnika} to stosunek ilości ładunku zgromadzonego na przewodniku do
...
\begin{definition}
  \bi{energia naładowanego kondensatora} to praca potrzebna do jego naładowania.
  \begin{gather*}
