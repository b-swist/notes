\chapter{Prąd elektryczny}
  \begin{definition}
    \bi{Prąd elektryczny} to uporządkowany ruch ładunków elektrycznych, których nośnikami w metalach są \textbf{elektrony}.
  \end{definition}
  ...
  \begin{definition}
    \bi{Natężenie prądu elektrycznego} to stosunek ilości ładunków przepływających przez przekrój poprzeczny przewodu do czasu, w którym ten ładunek przepłynął.
    \begin{equation}
  ...
  \section{Praca i moc prądu elektrycznego}
    ...
    \subsection{Moc prądu elektrycznego}
      \begin{definition}
        \bi{Moc prądu elektrycznego} to stosunek pracy wykonanej przez przepływające elektrony do czasu, w którym tą pracę wykonywały.
        \begin{subequations}
